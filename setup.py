...
setuptools.setup(
    ...
    url=f"https://github.com/PriyanshuDey23/Chicken_Disease_Classification",
    project_urls={
        "Bug Tracker":f"https://github.com/PriyanshuDey23/Chicken_Disease_Classification/issues"
    },
    package_dir={"":"src"},
